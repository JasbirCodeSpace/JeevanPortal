				   ...
				   $user_email = 'aa@gmail.com';
					...
					if ($_SERVER['REQUEST_METHOD'] == 'POST'){
						 if ($_POST['submit']){
							...
							$saathiFname=$_POST['first-name'] ;
							echo $saathiFname;
							
						}
						if(!empty($_POST['last-name'])){
						
							$saathiLname=$_POST['last-name'] ;
							echo $saathiLname;
					...
					if(strcmp($_POST['password_1'],$_POST['password_2']) == 0){
							mysqli_query($db,"use user") or die("DIE");
	                         ...
	                         $query = "insert into saathi values('$saathiFname','$saathiLname','$gender','$dob','$gmail','$user_email','$pswrd_1','$relation','$contact','$house','$city','$pincode','$state','$country','')";
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="form2.php"><i class="fa fa-edit"></i> ADD USER </a></li>
                  ...
                  <div class="x_content">
                    ...
                    <div id="wizard" class="form_wizard wizard_horizontal">
                      ...
                      <div id="step-1">
                        ...
                        <form class="form-horizontal form-label-left" action="#" method="POST" id="form1">
                          ...
                          <div class="form-group">
						   ...
						   <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input  type="email" id="user_email" name="gmail" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
						  
						    <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">User Email Address<span class="required"></span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input  type="email" id="gmail" name="user_gmail" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
