            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="form3.php"><i class="fa fa-edit"></i> ADD USER </a></li>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                   ...
                   <div id="step-3" >
                           <form class="form-horizontal form-label-left" action="" id="form3" method="POST" enctype="multipart/form-data >
						   <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">User Image <span class="required"></span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="file" id="user-pic" name="fileToUpload" id="fileToUpload"required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
						  
						  <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Saathi Image <span class="required"></span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
